 ...
 import profilePic from "../assets/kriti.jpg";
 ...
 const Hero = () => {
  return (
    <div className="border-b border-neutral-900 pb-4 lg:mb-35">
     ...
     initial="hidden"
     animate="visible"
          className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Kritika singh</motion.h1>
...
className="my-2 max-w-xl py-6 font-light tracking-tighter">
        ...
        <div className="flex justify-center">
          ...
          src={profilePic} alt="kritika singh"/>
        </div>
        </div>
      </div>
    </div>
